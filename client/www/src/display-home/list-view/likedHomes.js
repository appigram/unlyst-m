      ...
      if (authData) {
        ...
        ref.on("value", function (snap) {
          ...
          angular.forEach($scope.homeList, function (value, key) {
            ...
            var valuedThisHome = utility.hasValuedPropertyBefore($rootScope.authData.likedHomes,houseID);
